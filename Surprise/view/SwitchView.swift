...
enum OperationStatus {
    ...
    func title(type: OperationType) -> String {
        ...
        case .going:
            switch type {
            case .store:
                return "Please hold on for 5 seconds, then press Routing and follow the dashed circle to record the route to the surprise"
            case .search:
                return "Please hold on for 5 seconds, then press Searching and follow the the route to get the surprise"
            }
        case .done:
            switch type {
            case .store:
                return "Press Done if you've finish the route to the surprise"
            case .search:
                return "Press Done if you've got the surprise"
            }
        case .save:
            return "Press Save to store the surprise"
        }
    }
